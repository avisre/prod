...
test('stock comparison pages use the shared authenticated navbar', () => {
    ...
    assert.match(page.html, /assets\/system\.css\?v=20260905-fallback2/);
    assert.match(page.html, /assets\/app\.js\?v=20260905-fallback2/);
    ...
    assert.match(competitorPage, /assets\/system\.css\?v=20260905-fallback2/);
