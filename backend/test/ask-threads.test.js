...
test('asset stamps were bumped together (the ritual that bites twice)', () => {
    assert.match(askHtml, /assets\/app\.js\?v=20260830-mob6/);
    assert.match(askHtml, /assets\/system\.css\?v=20260830-mob6/);
    assert.match(profileHtml, /assets\/profile\.js\?v=20260830-mob6/);
