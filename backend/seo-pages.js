...
function nav(current = '') {
    ...
    return `<script>window.__spSkipAutoPageView=true;</script><script src="/assets/app.js?v=20260830-askui1"></script><script>V2.nav(${JSON.stringify(active)});</script>`;
}
