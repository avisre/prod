...
<link rel="stylesheet" href="/assets/system.css?v=20260831-askui2" />
...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .seo-crumbs a{color:var(--ink3);display:inline-block;padding:9px 2px}
  ...
  .seo-tile .l{font-size:11.5px;text-transform:uppercase;letter-spacing:.07em;color:var(--ink3);font-weight:600}
...
function nav(current = '') {
    ...
    return `<script>window.__spSkipAutoPageView=true;</script><script src="/assets/app.js?v=20260831-askui2"></script><script>V2.nav(${JSON.stringify(active)});</script>`;
}
