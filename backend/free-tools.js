...
body{margin:0;background:#fafaf9;color:#18202b;font:15px/1.55 system-ui,-apple-system,Segoe UI,sans-serif}main{max-width:900px;margin:0 auto;padding:32px 20px 70px}a{color:#5f5c55}.crumb{font-size:13px;color:#726e65}.hero{margin:28px 0 22px}.hero h1{font-size:38px;line-height:1.1;margin:0 0 10px}.hero p{color:#726e65;max-width:680px;font-size:17px}.panel{background:#fff;border:1px solid #e5e7eb;border-radius:14px;padding:20px;margin:18px 0;box-shadow:0 3px 12px #1118270a}.form{display:flex;gap:10px;flex-wrap:wrap}.form input{border:1px solid #cbd5e1;border-radius:8px;padding:12px;font:inherit;text-transform:uppercase;width:180px}.form button{border:0;border-radius:8px;padding:12px 18px;background:#111827;color:#fff;font:inherit;cursor:pointer}.hint,.note{font-size:13px;color:#726e65}.result h2{margin-top:0}.error{color:#b91c1c}.value-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(155px,1fr));gap:10px}.value{border:1px solid #e5e7eb;border-radius:10px;padding:12px}.value strong{display:block;font-size:20px;margin-top:3px}table{border-collapse:collapse;width:100%;margin-top:10px}th,td{text-align:left;border-bottom:1px solid #e5e7eb;padding:9px 7px;vertical-align:top}th{font-size:12px;text-transform:uppercase;color:#726e65}.cta{background:#eff6ff;border-color:#d8d5cd}.cta a{font-weight:700}.cta-bridge{margin:8px 0 0}.cta-bridge a{font-weight:600}.warning{background:#fffbeb;border-color:#fde68a;color:#92400e;padding:10px;border-radius:8px;margin-top:10px}.footer{margin-top:30px;color:#726e65;font-size:13px}@media(max-width:600px){.hero h1{font-size:30px}main{padding:24px 14px 50px}}
